class LendingsController < ApplicationController
  ...
  private
    ...
    def lending_params
      params.require(:lending).permit(:Name, :NickName, :Mailing_Address, :Email, :Phone, :SSN, :Passport, :Visa, :Assistant, :Manager, :Creator, :Create_Date, :Open_Date, :Prelim_Date, :Appraisal_Date, :Inspection_Date)
    end
end
