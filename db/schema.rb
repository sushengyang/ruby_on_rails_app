...
ActiveRecord::Schema.define(version: 20170425115657) do

  create_table "Loan", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "Name"
    t.string   "Nickname"
  ...
  create_table "related_dates", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",                                 null: false
    t.datetime "updated_at",                                 null: false
    t.index ["loan_id"], name: "index_related_dates_on_loan_id", using: :btree
  end
